...
export function UploadVideoTabs({ Card1, Card2 }) {
  return (
    <Tabs defaultValue="Videos" className="w-full">
      <TabsList className="grid w-full grid-cols-2">
        <TabsTrigger value="Videos">Videos</TabsTrigger>
        <TabsTrigger value="Shorts/Reels">Shorts/Reels</TabsTrigger>
      </TabsList>
      <TabsContent value="Videos">{Card1}</TabsContent>
      <TabsContent value="Shorts/Reels">{Card2}</TabsContent>
    </Tabs>
  );
}
